...
proceedings, excluding references. References can take up to one page. Note that only references can appear on the extra page. Sections such as conclusions or acknowledgments should not be placed on the extra references page.
